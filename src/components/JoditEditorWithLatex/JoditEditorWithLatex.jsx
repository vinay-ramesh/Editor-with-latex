...
//   // Function to convert LaTeX to SVG and insert
...
//       // Create a temporary div to measure dimensions
//       const tempDiv = document.createElement('div');
//       tempDiv.innerHTML = html;
//       tempDiv.style.position = 'absolute';
//       tempDiv.style.left = '-9999px';
//       tempDiv.style.fontSize = '18px';
//       tempDiv.style.fontFamily = 'KaTeX_Main';
...
//           <foreignObject x="10" y="10" width="${width}" height="${height}">
//             <div xmlns="http://www.w3.org/1999/xhtml" style="font-size: 18px; line-height: 1.2;">
//               ${html}
//             </div>
//           </foreignObject>
//         </svg>
...
//       // Insert as image
//       editorInstance.s.insertImage(dataUrl, {
